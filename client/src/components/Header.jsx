      ...
      <div className=" mx-auto p-4 flex justify-between items-center font-rubik w-[80%]">
        ...
        >
          {isIconMenuOpen ? (
            ...
            <img src="/image/icon.svg" alt="" className="w-8 h-8" />
          )}
        </div>
        ...
        >
          ...
          <div className="absolute right-0 top-0 w-[25%] h-full bg-black text-white p-4 z-20 opacity-100">
            <div className="flex flex-col items-center justify-center mt-20  ">
              ...
              Recusandae repellat libero ducimus nihil sint, voluptas eaque
              architecto eum nesciunt et, deleniti nulla delectus harum
              accusantium. Iste dolor exercitationem maxime delectus, tenetur
              animi esse commodi expedita saepe sed beatae reprehenderit, odit
              sint quia repudiandae! Numquam unde doloremque ratione tempore
              velit aperiam.
            </div>
          </div>
        </div>
